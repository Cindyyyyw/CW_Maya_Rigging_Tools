...
class MainUI(QtWidgets.QWidget):
    ...
    def process_xml_file(self):
        ...
        try:
            ...
            for i in range(size):
                ...
                reversed_value = self.reverse_normalized_value(value)
    ...
    def importXML(self):
        cmds.deformerWeights(self.xmlProcessedFileName, path=self.workDir , im=1, method='index', df = self.blendShapeNode_cbb.currentText())
    ...
    def runInvert(self):
        ...
        self.deleteXML([self.xmlProcessedFilePath, self.xmlFilePath ])
